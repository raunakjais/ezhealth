...
<table width="720" cellpadding="1" cellspacing="1"> 
		  ...
		  <?php 
		  $get_recp = mysql_query("select RECEPTIONIST_ID,RECEPTIONIST_FIRST_NAME,RECEPTIONIST_LAST_NAME,RECEPTIONIST_MOBILE_NUMBER,RECEPTIONIST_EMAIL,RECEPTIONIST_FLAG from receptionist_register where RECEPTIONIST_IDENTITY='".$get_bid->USER_UN_ID."' and RECEPTIONIST_FLAG=0");
