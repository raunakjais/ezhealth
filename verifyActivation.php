...
include("config/config.php"); 
	$get_det=mysql_fetch_object(mysql_query("select * from user_registration_code where USER_REG_CODE_ID='".$_REQUEST['reg_id']."'"));
?>
...
<div class="midcontainer">
		...
		Welcome <?php print $get_det->USER_REG_CODE_USERNAME;?> Thanks for joining with us..<br/>
...
{
	$uname=$get_det->USER_REG_CODE_USERNAME;
	$email=$get_det->USER_REG_CODE_EMAIL;
	$randomnumber=$get_det->USER_REG_RANDOM_CODE;
	if($randomnumber!='')
	{
	...
	$num=mysql_num_rows($row);*/
		if($_REQUEST['regcode']==$randomnumber)
		{
			if($_REQUEST['u_type']=='D')
			{
