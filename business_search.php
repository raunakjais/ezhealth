...
<table width="775" cellpadding="0" cellspacing="0"> 
		  ...
		  <tr>
			...
			<div id="name" style="display:none;"><input type="text" name="buss_name" id="buss_name"  class="textfiled-M" value=""  placeholder="Type The Business Name"/></div>
			<div id="loc" style="display:none;"><input type="text" name="loc_name" id="loc_name"  class="textfiled-M" value=""  placeholder="Type The Location Name"/></div>
			</td>
		...
		<td width="24%">
			<table width="185" style="border:solid 1px #e7e7e7;">
				...
				<tr>
				  ...
				  <td valign="top" class="text1">&nbsp;</td>
				  <td align="right" valign="top" class="text3"><a href="buss_view.php?id=<?=$val->BUSINESS_ID?>">View More..</a></td>
			  </tr>
			</table>		
		</td>
