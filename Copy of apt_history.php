...
<form name="search1" method="post" action="">
  <table width="100%" cellpadding="1" cellspacing="1" align="center">
	...
	?>
    <tr>
      <td width="61" class="timetabH5"><?=$i?></td>
      <td width="193" class="timetabH5"><? print date('D', strtotime($val->APT_DATE)).', '.$slot_time->START_TIME; ?></td>
	  <td width="175" class="timetabH5" align="center"><?=$val->FNAME.' '.$val->LNAME?></td>
	  <td width="170" class="timetabH5" align="center"><?=$val->APT_REASON?></td>
	  <td width="119" class="timetabH5" align="center">
	  <? if($sel_pres>0) { ?> 
    ...
    <tr>
      <td width="61" class="timetabH5"><?=$i?></td>
      <td width="193" class="timetabH5"><? print date('D', strtotime($val1->APT_DATE)).', '.$slot_time->START_TIME; ?></td>
	  <td width="175" class="timetabH5" align="center"><?=$val1->FNAME.' '.$val1->LNAME?></td>
	  <td width="170" class="timetabH5" align="center"><?=$val1->APT_REASON?></td>
	  <td width="119" class="timetabH5" align="center">
	  <? if($sel_pres1>0) { ?> 
	  <img src="images/prescription.png" title="Prescription already added" />
	  <? } else { ?>
