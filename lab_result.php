...
<tr>
	<td colspan="3"><h1 style="color:#003162;">Lab Result</h1></td>
</tr>
<tr>
	<td colspan="3">&nbsp;</td>
</tr>
 <tr>
	<td colspan="3">Lab Result For</td>
</tr>
<tr>
	<td colspan="3">
	<?php $sel_fam=mysql_query("select * from patient_family where PATIENT_ID='".$_SESSION['pat_id']."'"); ?>
		<select name="pat_list" id="pat_list" class="drop2" onchange="getfamdet(this.value,'lab_result');" >
