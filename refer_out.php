...
{	
	$query = "select * from refer_patient where REFER_FROM='".$_SESSION['doc_id']."' and REFER_FROM_TYPE='D'";
?>
...
<tr><td colspan="8"><h2 style="color:#003162;">Referral Out</h2></td></tr>
<tr>
<td colspan="8">&nbsp;</td>
</tr>
...
<th width="404" class="timetabH4">To ( Name ) </th>
...
<th width="242" class="timetabH4">Referral Date</th>
		...
		<tr>
			...
			<td class="timetabH1"><? if($row['REFER_TO_TYPE']=='D') { print 'Dr. '; } print $to; ?></td>
