...
<a class="iframe" href="<?php if($_SESSION['user_type']=='D' || $_SESSION['user_type']=='R'){ ?> book_d.php <?php } if($_SESSION['user_type']=='P'){?>book_p.php<? } ?>?dt=<?php print $apt_date; ?>&bk_id=<?php print $lp; ?>">
