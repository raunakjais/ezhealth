...
<form name="search1" method="post" action="" >
						<table width="100%" cellpadding="0" cellspacing="0" border="0"> 
								...
								<tr>
									...
									?>
									<td colspan="4">
									  <table width="177" border="0" style="border:solid 1px #e7e7e7;">
									  ...
									  <tr>
											...
											<tr>
												<td width="4" valign="top" class="text1"></td>
												<td width="50" valign="top" class="text1">Name</td>
											  <td width="5" valign="top" class="text1">:</td>
											  <td width="98" valign="top" class="text1">Dr. <? print $get_name->DOCTOR_FIRST_NAME.' '.$get_name->DOCTOR_LAST_NAME;?></td>
										  </tr>
											<tr>
												<td width="4" valign="top" class="text1"></td>
												<td width="50" valign="top" class="text1">City</td>
											  <td width="5" valign="top" class="text1">:</td>
											  <td valign="top" width="98" class="text1"><? print $city_name->CITY_NAME;?></td>
										  </tr>
											<tr>
												<td width="4" valign="top" class="text1"></td>
												<td width="50" valign="top" class="text1">Practicing</td>
											  <td width="5" valign="top" class="text1">:</td>
											  <td valign="top" width="98" class="text1"><? print $pic->DOCTOR_EXP; ?> years</td>
										  </tr>
											<tr>
												<td width="4" height="" valign="top" class="text1"></td>
												<td width="50" height="" valign="top" class="text1">Address</td>
											  <td width="5" valign="top" class="text1">:</td>
											  <td height="50" valign="top" width="98" class="text1"><? print $pic->DOCTOR_ADDRESS.', '.$city_name->CITY_NAME.', '.$country_name->COUNTRY_NAME; ?> </td>
										  </tr>
											<tr>
									...
									<?php if($count==3) { ?> <tr><td colspan="4">&nbsp;</td></tr>   </tr> <tr> <?php $count=0; } else { $count=$count+1; }
									}
									?>
								</tr>
								</table>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">     
  ...
  <tr>
   <td width="36%"><input type="radio" name="search" id="s1" value="1" onclick="name1();"  />&nbsp;&nbsp;Speciality </td>
		
   <td width="36%"><input type="radio" name="search" id="s2" value="2" onclick="name1();"  />&nbsp;&nbsp;Name </td>

<td width="13%"><input type="radio" name="search" id="s3" value="3" onclick="name1();" />&nbsp;&nbsp;Problem</td>
<td width="15%">&nbsp;</td>
  </tr>
  <tr>
	<td colspan="4">&nbsp;</td>
   ...
   <tr> <td colspan="3"> <div id="byproblem" style="display:none;"> 
	...
	<td><input class="but-search" type="button" onclick="search_list();"  /></td>
	<td>&nbsp;</td>
	</tr>
	<tr>
