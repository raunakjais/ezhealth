...
//******************************************************************************
    ...
    var scwTodayCellBorderColour = '#CC0000';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #91b8e5;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #FFFFFF;'   +
                                        'color:             #91b8e5;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #ddecfe;}'  +
            '/* Week day headings */'                                   +
            'td.scwWeek                 {color:             #FFFFFF;}'  +
            '/* Week numbers */'                                        +
            'td.scwWeekNo               {background-color:  #91b8e5;'   +
                                        'color:             #000000;}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #eaf3ff;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  #FFFFFF;'   +
                                        'color:             #FF0000;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #fdf2da;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #FFFFFF;'   +
                                        'color:             #8E0000;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #91b8e5;'   +
                                        'color:             #FFFFFF;}'  +
            ...
            '/* Week Day */'                                            +
            '/* Day matching the input date */'                         +
            'td.scwInputDateDisabled    {background-color:  #FFFFFF;'   +
                                        'color:             #000000;}'  +
