...
{	
	$row=mysql_fetch_array(mysql_query("select * from msg where BK_ID='".$_REQUEST['bookng_id']."' and TYPE='prescription'"));
?>
...
<tr>
	<td colspan="6"><h2 style="color:#003162;">Prescription notification</h2></td>
...
<tr>
<td colspan="8"><h4><?=$row['MSG']?><? if($row['TYPE']=='prescription') { ?> <? } ?></h4></td>
</tr> 
</table>
</form>
</div>
