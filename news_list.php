...
<tr>
<td colspan="4"><h2 style="color:#003162;">News List </h2></td>
</tr>
<td colspan="4" height="6"></td>
            <tbody><tr>
	         <th width="110" class="timetabH4">Serial No.</th>
	         <th width="233" class="timetabH4">News</th>
	         <th width="875" class="timetabH4">Description</th>
			 <th width="119" class="timetabH4">Edit</th>
			</tr>		
			<?php 
			$query=mysql_query("select * from news order by CDATE DESC");
			$sl=1;
			...
			<td width="119" class="timetabH2"><a href="latest_news.php?id=<?=$val->NEWS_ID?>"><img src="images/edit.png"  /></a></td>
			</tr>
			<?php  $sl=$sl+1; } ?>
			</tbody></table>
			<input class="but-blue" type="button" name="submi" value="Add News" onclick="window.location='latest_news.php'" >
			</div>
			</div>
			</div>
</body>
